...
{cljs.core.swap_BANG_.call(null,client.state,cljs.core.assoc,"﷐'nick",msg__1944);
websocket.emit_BANG_.call(null,soc,"nick",msg__1944);
}
return e__1943.value = "";
});
});
client.init_controls = (function init_controls(handler){
var input__1945 = goog.dom.getElement.call(null,"msg");

(new goog.ui.LabelInput()).decorate(input__1945);
(new goog.ui.Tooltip(input__1945,input__1945.getAttribute("label")));
logger.info.call(null,"client",cljs.core.str.call(null,"Installing handler on ",input__1945));
goog.events.listen.call(null,input__1945,goog.events.EventType.CHANGE,handler);
input__1945.focus(true);
return (new goog.ui.AnimatedZippy("log-h","log",false));
});
client.disable_controls = (function disable_controls(){
var input__1946 = goog.dom.getElement.call(null,"msg");

input__1946.disabled = true;
return input__1946.hidden = true;
});
client.install_shutdown_hook = (function install_shutdown_hook(f){
var body__1947 = document.body;

logger.info.call(null,"client","Installing unload hook.");
return body__1947.onunload = f;
});
client.init = (function init(){
logger.init.call(null,"log");
logger.info.call(null,"client","Initilizing application.");
var temp__3723__auto____1948 = websocket.connect_BANG_.call(null,websocket.configure.call(null,websocket.create.call(null),client.websocket_opened,client.websocket_message,client.websocket_error,client.websocket_closed),'ws://' + document.location.host + '/socket');

if(cljs.core.truth_(temp__3723__auto____1948))
{var socket__1949 = temp__3723__auto____1948;

client.install_shutdown_hook.call(null,(function (){
return websocket.close_BANG_.call(null,socket__1949).call(null);
}));
return client.init_controls.call(null,client.create_message_change.call(null,socket__1949));
} else
